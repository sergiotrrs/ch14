//Algoritmo: Solicitar 3 números (entre el 1 y el 100) y definir cuál es el menor
...
alert("Programa que solicita 3 números (entre el 1 y el 100) y define cuál es el menor")
