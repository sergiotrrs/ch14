/**1.-Solicita 3 numero entre 1 y 100 y define cual es el mayor**/
...
decidira cual es el mayor numero*/ 
 let titulo;
  if((x>y)&&(x>z)){
    ...
    titulo=alert("El número mayor es: "+x);
  }else if((y>z)&&(y>x)){
    console.log("El número mayor es: ", y);
    titulo=alert("El número mayor es: "+y);
  }else{
    console.log("El número mayor es: ", z);
    titulo=alert("El número mayor es: "+z);
  }
}
...
//Imprimo en consola los valores que solicito el usuario
console.log("El primer valor es: ",numero1);
console.log("El segundo valor es: ",numero2);
console.log("El tercer valor es: ",numero3);

//Llamamos a la funcion que encuentra el nuemro mayor
let nMayor=mayor(numero1,numero2,numero3);