 ...
 */
setInvisible(true); //establecer como invisible el botón de limpiar
function setInvisible(estado){
   ...
   //formulario.elements['limpiar'].style.display =
}

const form = document.getElementById("formulario");

form.addEventListener('submit', (event) => {
    event.preventDefault(); //Con event puedo evitar que se me borre la pantalla
    console.log(event);
    calcularFecha();
    setInvisible(false);
})
