...
//False, null, NaN, 0, empty string o unidefined son considerados con valor false:
//Si el primer operador es true, el resultado es el valor del segundo operador
console.log("true && NaN = " + (true && NaN)); //NaN
console.log("false && 'Hola estrella' = " + (true && 'Hola estrella'));//true
...
//de la izquierda es null o undefined. De lo contrario, retorna el operador
