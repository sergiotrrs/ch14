/*Ejercicio 1 para revisar qué número es el mayor de tres números
...
//Este bloque va a revisar que el primer número sea el mayor
if (primerNumero > segundoNumero) {
    if (primerNumero > tercerNumero) {
        window.alert(`El primer numero, el ${primerNumero}, es el número mayor`);
    }
}
//Este bloque revisa que el segundo número sea mayor
if (segundoNumero > primerNumero) {
    if (segundoNumero > tercerNumero) {
        window.alert(`El segundo numero, el ${segundoNumero}, es el número mayor`);
    }
}
//Este bloque termina el código, al declarar que el tercer número es el mayor
if (tercerNumero > primerNumero) {
    if (tercerNumero > segundoNumero) {
        window.alert(`El tercer numero, el ${tercerNumero}, es el número mayor`);
    }
}