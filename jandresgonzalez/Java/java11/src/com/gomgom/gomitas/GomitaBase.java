...
public class GomitaBase {
	...
	public GomitaBase(String nombre, int color, String sabor, double precio) {
		//this() va a construir con base en el método constructor
		//si hay un método overloaded, se puede poner los parámetros de ese método para que se realice tal
		this(nombre);
		//super();
		this.nombre = nombre;
		this.color = color;
	...
	public String toString() {
		return "Mundo gomitas " + this.nombre + ". (Hash: " + super.toString() + ").";
	}
