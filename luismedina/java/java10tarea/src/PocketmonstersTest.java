...
public class PocketmonstersTest {
	...
	public static void main(String[] args) {
		...
		Trainer lucia = new Trainer("Lucia", 21, "Planta", new Pocketmonsters("Chikorita", "Planta", 90));
		...
		gimnasio.put(8, new Trainer("Cori", 28, "Venezolanos", new Pocketmonsters("Mew", "Psiquico", 40)));
