...
//Para funciones expresadas, no se aplica el hoisting, si tiene que estar declarada la variable.
...
console.log("El resultado es " + residuo(9,2));

//Funciones dentro de objetos***********************************

const participante = {
    nombre: "Jorge", //nombre:(clave) "Jorge"(valor)
    apellido: "Montalvo",//apellido:(clave) "Montalvo"(valor)
    nombreCompleto: function (){ //nombreCompleto: (clave) toda la funcion (valor)
