console.log("Teoría de la sesoón JS05, operadores")
...
x++; //3
console.log("El valor de x con ++ : " + x ); //3

//Decremento en una unidad
x = x - 1; //2
//El operador --, devuelve el valor, después decremento en una unidad
x--; //1
console.log("El valor de x con -- : " + x ); //1
...
//Operador igual que, compara el valor de dato
x= 1;
y= 2;
x == y; //false
y= 1;
...
console.log("Asignación de asistencia = x :" + (asistencia = '' ?? 'Asiste')); //'' string vacío
...
//string es =
//number es =
//Para un tipo de dato null, todos sus bits (1 y 0) son 00000000000.00