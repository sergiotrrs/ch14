...
public class VariablesOperadores {
	...
	public static void main(String[] args) {
		...
		char datoChar = 'a';
		//datoChar = 'E'; //Literal
		//datoChar = '\u0045'; //Código único del caracter
		datoChar = 69; //Valor décimal del caracter
		...
		var edad = 18; //variable de tipo Int
		var isAceptado = true; // de tipo boolean
		var caracter = 'a';
		
		System.out.println("El \"caracter\" \n es: " + caracter); // (\" \") para encerrar entre comillas y \n para hacer salto de línea
