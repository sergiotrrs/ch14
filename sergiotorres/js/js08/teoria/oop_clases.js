...
class Elote{
    ...
    //Al estar encapsulado, no puedo acceder diretamente al atributo
    #tipo;
    #costo;
    #servido;
...
// Con la plabra extends estamos heredando los atributos y clases de la clase superior.
class EloteGourmet extends Elote{
    #caducidad

    //Así como .this hace referencia al objeto que lo invoca
    // la palbras super invoca a los atributos y métodos de la clase superior, incluyendo el constructor
    constructor(tipo, costo, servido ){
        //super.costo = costo; De esta forma podríamos establacer los parámetros
