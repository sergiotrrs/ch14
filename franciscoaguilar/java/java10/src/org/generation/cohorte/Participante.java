...
public class Participante {
	...
	public Participante(String string, int i, org.generation.mascota.Perrito perrito) {
	...
	public String datos(){
		return this.nombre+", "+this.edad+
				". Tiene de mascota a "+this.mascota.getNombre()+". Su mentora es: "+this.mentor.getNombre();
