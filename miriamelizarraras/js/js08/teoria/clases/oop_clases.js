...
class Elote{
     ...
     * Para invocar setter o getter no se utilizan parentesis como las funciones.
     */
...
class EloteGourmet extends Elote{
    ...
    constructor(tipo, costo, servido ){
        //super.costo = costo; de esta forma podriamos establecer los parámetros que no estén encapsulados
        super(tipo, costo, servido) //Estableciendo super() se accede al constructor de la clase superior.
        this.#caducidad = Date.now()+1000*60*10 // Date.now() Me entrega el valor en milisegundos (ms) 1000ms*60=1 min * 10
    }
...
/**********El polimorfismo *****
 * 
 * Establece que una funciín debe tener acceso tanto en la clase superior como en la clase inferior.
 * 
 */
