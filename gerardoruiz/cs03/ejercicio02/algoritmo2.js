/*Algoritmo 2
Solicitar 3 números (entre el 1 y el 100) para definir el menor de tres números*/
...
if (num1 > 100 || num2 > 100 || num3 > 100){
   document.write("Uno de los numeros ingresados es mayor a 100, favor de reintentar")
    ...
    alert(num1 + " Es el número es el menor.");
} 
else if (num2 < num1 && num2 < num3){
   alert(num2 + " Es el número es el menor.");
   
} else if (num3 < num1 && num3 < num2){
   alert(num3 + " Es el número es el menor.");
}