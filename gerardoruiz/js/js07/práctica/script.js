...
const URL_DELAY="https://reqres.in/api/users?page=1";
const URL_PAGE2="https://reqres.in/api/users?delay=3";
...
page2.addEventListener('click',()=>{document.getElementById("tableTitle").innerHTML="Página 3 Delay";requestData(URL_PAGE2,2);});
