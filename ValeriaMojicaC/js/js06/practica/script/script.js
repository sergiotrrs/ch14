/**
 * Establecer como invisible el boton limpiar
...
form.addEventListener('submit', (event ) => {
    //Evita que borre los datos del formulario
    event.preventDefault();
    //La funcion se coloca aca para que se haca despues de verificar los pasos
    calcularFecha();
    console.log(event);
    setInvisible(false);
})
...
/**
 * se utiliza para ondicar los parametros en una funcion
 * Hace referencia a los parametros de entrada {tipo} nombre descripcion
 * @param {int} anio
 * @param {int} mes
 * @param {int} dia
...
const calcularFecha = () =>{ 
     ...
     */
    //Se coloca -1 en el mes porque inica de cero
